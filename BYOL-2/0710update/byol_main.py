...
from flcore.servers.serverFedBN import FedBN
from flcore.servers.byol_serveravg import FedBYOL
    ...
    for i in range(times):
        ...
        if model == "mclr":
            ...
            if "Mnist" in dataset or "EMnist" in dataset:
                ...
                print("use cnntarget_bn")
                Model = CNNTarget_bn(out_dim=num_labels).to(device)
            else:
        ...
        if algorithm == "FedAvg":
        ...
        elif algorithm == "FedBYOL":
            server = FedBYOL(device, dataset, algorithm, Model, local_batch_size, local_learning_rate, global_rounds,
                            local_steps, join_clients, num_clients, i, eval_gap, client_drop_rate, train_slow_rate, 
                            send_slow_rate, time_select, goal, time_threthold)
            ...
            server = FedBN(device, dataset, algorithm, Model, local_batch_size, local_learning_rate, global_rounds,
                            local_steps, join_clients, num_clients, i, eval_gap, client_drop_rate, train_slow_rate, 
                            send_slow_rate, time_select, goal, time_threthold)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-algo', "--algorithm", type=str, default="FedAvg",
                        ...
                        "FedFomo", "MOCHA", "FedPlayer", "FedAMP", "HeurFedAMP","FedRep","FedBN"])
